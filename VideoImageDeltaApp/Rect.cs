/// <summary>
/// A derived version of System.Windows.Rect. Can't inherit structs, so, made a copy instead.
/// Just needed to add anchors...
/// </summary>
...
namespace VideoImageDeltaApp
{
    ...
    public partial struct Rect
    {
                    ...
                    double height)
        {
            if (width < 0 || height < 0)
            {
                throw new ArgumentException(/*SR.Get(SRID.Size_WidthAndHeightCannotBeNegative)*/);
            }
        ...
        public Point Location
        {
            ...
            set
            {
                if (IsEmpty)
                {
                    throw new InvalidOperationException(/*SR.Get(SRID.Rect_CannotModifyEmptyRect)*/);
                }
        ...
        public double Width
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new ArgumentException(/*SR.Get(SRID.Size_WidthCannotBeNegative)*/);
                }
        ...
        public bool Contains(Rect rect)
        {
            ...
            return (_x <= rect.X &&
                    _y <= rect.Y &&
                    _x + _width >= rect.X + rect.Width &&
                    _y + _height >= rect.Y + rect.Height);
        }
        ...
        public void Offset(Vector offsetVector)
        {
            if (IsEmpty)
            {
                throw new InvalidOperationException(/*SR.Get(SRID.Rect_CannotCallMethod)*/);
            }
